...
data = pd.read_csv("atis-airlinetravelinformationsystem/atis_intents_train.csv").values
data_test = pd.read_csv("atis-airlinetravelinformationsystem/atis_intents_test.csv").values
